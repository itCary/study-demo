...
public class Client {
    ...
    private static String getFileName(WebDriver driver) {
        return driver.findElement(By.xpath("/html/body/div/div[2]/div[2]/span[4]/h1/a")).getText();
    }

    private static void requestHtml(WebDriver driver, String videoUrl) {
        driver.get(videoUrl);
        //当前页句柄,切换到当前页
